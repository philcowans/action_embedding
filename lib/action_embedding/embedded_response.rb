# This is the Rails 2.3.8 Response class, which allows for easy
# extraction of the response to be returned in the standard Rack
# fashion. In the current application it allows us to use a common
# interface for Rails 2.2.x (which doesn't use Rask internally) and
# Rails 2.3.x (which does).

require 'digest/md5'

module ActionEmbedding # :nodoc:
  ...
  #    end
  #  end
  class EmbeddedResponse < Rack::Response
